...
pilot_data1$kondo_video_01 <- ifelse(pilot_data1$Q21 == "" & pilot_data1$Q22 != "", 0, NaN)
pilot_data1$kondo_video_01 <- ifelse(pilot_data1$Q21 != "" & pilot_data1$Q22 == "", 1, pilot_data1$kondo_video_01)

#25,30
check_code <- pilot_data1[c("Q21", "Q22", "kondo_video_01")]

count(check_code, vars=kondo_video_01)
